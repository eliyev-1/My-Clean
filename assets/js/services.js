...
fetch("../json/services.json").then(function(response){
     ...
     servicesData?.map(item=>{
      let servisCard = document.createElement('a')
      servisCard.innerHTML = `
      <div class="services__card">
          ...
          <div class="services__card__right">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod 
              ...
              quis nostrud exercitation ullamco laboris nisi ut Lorem ipsum dolor sit amet, consectetur 
            </p>
      ...
      `;
      servisCard.href="../html/servicesDetail.html"
      services.appendChild(servisCard);
