let servicesDetail = document.querySelector('.servicesDetail')
let servicesDetail__data=localStorage.getItem("servicesDetail__data__link")
var servicesDetail__data__parse = JSON.parse(servicesDetail__data);
servicesDetail.innerHTML = `
<div class="servicesDetail__image">
            <img src=" ${servicesDetail__data__parse.img}" alt="">
      </div>
      <div class="servicesDetail__tittle">
            <h3>${servicesDetail__data__parse.header}</h3>
            <p>
            ${servicesDetail__data__parse.tittle.slice(0,100)}
            </p>
      </div>
      ...
      <div class="servicesDetail__tittle">
            <p>
            ${servicesDetail__data__parse.tittle.slice(100)}
            </p>
            <a href="./apply.html">
...
pageName.innerHTML = `${servicesDetail__data__parse.header}`